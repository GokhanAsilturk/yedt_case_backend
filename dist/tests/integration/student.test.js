...
describe('Student Integration Tests', () => {
    ...
    afterEach(async () => {
        ...
        await User_1.default.destroy({ where: { id: { [sequelize_1.Op.ne]: adminUserId } } });
    });
    afterAll(async () => {
    ...
    describe('PUT /api/students/:id', () => {
        it('should update an existing student', async () => {
            ...
            const updatedStudent = await Student_1.default.findByPk(testStudentId, {
                include: [
                    {
            ...
            expect((_a = updatedStudent === null || updatedStudent === void 0 ? void 0 : updatedStudent.user) === null || _a === void 0 ? void 0 : _a.firstName).toBe('Updated');
            expect((_b = updatedStudent === null || updatedStudent === void 0 ? void 0 : updatedStudent.user) === null || _b === void 0 ? void 0 : _b.lastName).toBe('Name');
        });
    ...
    describe('DELETE /api/students/:id', () => {
        it('should delete an existing student', async () => {
            ...
            const deletedStudent = await Student_1.default.findByPk(testStudentId);
        ...
        it('should delete student with associated enrollments', async () => {
            ...
            const course = await (0, supertest_1.default)(app_1.default)
                .post('/api/courses')
                .set('Authorization', `Bearer ${adminToken}`)
                .send({
                name: 'Test Course',
            ...
            const enrollments = await Enrollment_1.default.findAll({ where: { studentId: testStudentId } });
